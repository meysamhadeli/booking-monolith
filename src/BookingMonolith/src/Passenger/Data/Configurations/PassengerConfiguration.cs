...
namespace BookingMonolith.Passenger.Data.Configurations;

[RegisterPassengerConfiguration]
public class PassengerConfiguration : IEntityTypeConfiguration<Passengers.Models.Passenger>
{
    ...
    {
        RelationalEntityTypeBuilderExtensions.ToTable((EntityTypeBuilder)builder, nameof(Passengers.Models.Passenger));
