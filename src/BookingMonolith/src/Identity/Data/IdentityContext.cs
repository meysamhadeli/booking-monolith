                                          ...
                                          UserClaim, UserRole, UserLogin, RoleClaim, UserToken>, IDbContext
{
    ...
    {
        var types = typeof(IdentityRoot).Assembly.GetTypes()
            .Where(t => t.GetCustomAttribute<RegisterIdentityConfigurationAttribute>() != null)
            .ToList();
        ...
        builder.HasDefaultSchema(nameof(Identity).Underscore());
